		...
		module.exports = [function(callback) {
			...
			_.jsonp("http://v.youku.com/player/getPlaylist/VideoIDS/" + _id + "/Pf/4/ctype/12/ev/1", {}, function(param) {
				...
				if (!/PlayStation/.test(window.navigator.userAgent) && _.canPlayM3U8) {
					...
					var t = new T(a);
					videosrc = t._videoSegsDic["mp4"][0]!=null ? t._videoSegsDic["mp4"][0].src : t._videoSegsDic["3gphd"][0].src;
					document.body.innerHTML="<video id=\"theatre\" src=\""+videosrc+"\" controls=\"controls\" height=\"100%\" weight=\"100%\" autoplay=\"autoplay\">您的浏览器不支持 video 标签。</video>";
					callback({
						"&#x6807;&#x6E05;": videosrc
					})
				}
